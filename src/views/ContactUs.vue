  ...
  <section class="bg-white dark:bg-gray-900">
    <div class="container px-6 py-12 mx-auto">
      <div class="text-center ">
        ...
        <h1 class="mt-2 text-2xl font-semibold text-gray-800 md:text-3xl dark:text-white">We’d love to hear from you
        </h1>
      ...
      <div class="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2 sm:grid-cols-2 ">
        <div class="p-4 rounded-lg bg-gradient-to-r from-emerald-500 to-lime-600  md:p-6 dark:bg-gray-800">
          ...
          <p class="mt-2 text-sm text-gray-800 dark:text-gray-100">Speak to our friendly team.</p>
          <p class="mt-2 text-sm text-gray-800 dark:text-blue-400">tebogo@homeroasty.co.za</p>
        </div>
        ...
        <div class="p-4 rounded-lg bg-gradient-to-r from-emerald-500 to-lime-600 md:p-6 dark:bg-gray-800">
          ...
          <p class="mt-2 text-sm text-gray-800 dark:text-gray-400">Call us </p>
          <p class="mt-2 text-sm text-gray-800 dark:text-blue-400">081434 2904 or 069367 1343
          </p>
        </div>
      </div>
    </div>
...
export default {
  data() {
    return {
      imageSrc: require('@/assets/clean.jpg')
    }
  }
}
</script>
